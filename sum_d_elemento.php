...
$elementos=mysqli_query($conex_surc,"SELECT
 ...
 surc.surc_sumarioelemento.SURC_SumarioElemento_CantElem AS 'Cantidad', surc.surc_sumarioelemento.SURC_SumarioElemento_NroSerieE AS 'Numero_de_Serie', surc.surc_sumarioelemento.SURC_SumarioElemento_Obs AS 'Observaciones', surc.surc_formaelemento.SURC_FormaElemento_Descrip AS 'Condicion',surc.surc_sumarioelemento.SURC_SumarioElemento_Estado as 'estado'  FROM surc.surc_sumarioelemento
