...
if (!empty($_REQUEST['SURC_Sumario_Id'])) {
	...
	SURC_Sumario_Anio AS 'Anio', SURC_TipoDelito_Descripc as 'Caratula',dbseg.ref_dependencias.DepPol_Codigo as 'Id_deppol_codigo',dbseg.ref_dependencias.DepPol_Descrip AS 'Dependencia', surc.surc_tiposum.SURC_TipoSum_Id as 'Id_Tipo_Sumario',surc.surc_tiposum.SURC_TipoSum_Descrip AS 'Tipo_Sumario',surc.surc_origensumario.SURC_OrigenSumario_Id AS 'Id_origen'	,	surc.surc_origensumario.SURC_OrigenSumario_Descrip AS 'Origen_Sumario',
	dbseg.ref_localidad.Localidad_Codigo as 'Id_localidad',	dbseg.ref_localidad.Localidad_Descrip AS 'Localidad', dbseg.ref_barrio.Barrio_Codigo AS 'Id_Barrio' ,dbseg.ref_barrio.Barrio_Descrip AS 'Barrio',
	SURC_Sumario_NomCalle AS 'Nom_Calle', SURC_Sumario_AltCalle AS 'Alt_Calle',
	SURC_Sumario_Piso as 'Piso', SURC_Sumario_Dpto as 'Dpto', SURC_Sumario_Mza as 'Mza', SURC_Sumario_CasaLote as 'lote', SURC_Sumario_CoordX AS 'Coord_X', SURC_Sumario_CoordY AS 'Coord_Y', surc.surc_sumario.SURC_Sumario_IdCuadricula as 'Id_Cuadricula' ,surc.surc_cuadriculas.SURC_Cuadriculas_Descrip AS 'Cuadricula',
	if (SURC_Sumario_FechaDel= '1000-01-01',null, SURC_Sumario_FechaDel) AS 'Fecha_Delito',
	if (SURC_Sumario_HoraDel='1000-01-01 00:00:00',null,time(SURC_Sumario_HoraDel)) AS 'Hora_Delito', surc.surc_sumario.SURC_Sumario_IdLugar AS 'Id_Lugar_Hecho',
	surc.surc_lugares.SURC_Lugar_Descrip AS 'Lugar_Hecho',surc.surc_juzgadofiscalia.SURC_JuzgadoFiscalia_Id AS 'Id_Fiscalia',
	...
	SURC_Sumario_TextoRelato AS 'Descrip_Hecho', surc.surc_sumario.SURC_Sumario_IdHechoDel as 'Id_Hechodelictivo',
	surc.surc_hechodelictivo.SURC_HechoDelictivo_Descrip as 'Tipo_hechodelictivo',
	surc.surc_sumario.SURC_Sumario_Tentativa as 'tentativa',
	surc.surc_sumario.SURC_HechoDelictivo_VIF as 'hechodelictivo_vif',
	surc.surc_sumario.SURC_Sumario_IdArmaMec as 'Id_armamec',
	surc.surc_armamecanismo.SURC_ArmaMecanismo_Descrip as 'desc_armamec',
	surc.surc_sumario.SURC_Sumario_IdFormaAcc as 'Id_formaacc',
	surc.surc_formaaccion.SURC_FormaAccion_Descrip as 'desc_formaacc',
	surc.surc_sumario.SURC_Sumario_IdModalidad AS 'Id_modalidad',
	surc.surc_modalidad.SURC_Modalidad_Descrip as 'desc_modalidad',
	surc.surc_sumario.SURC_Sumario_IdModoProd as 'Id_modoprod',
	surc.surc_modoproduccion.SURC_ModoProduccion_Descrip as 'desc_modoprod',
	surc.surc_sumario.SURC_Sumario_IdCondClim as 'Id_condclim',
	surc.surc_condclimatica.SURC_CondClimatica_Descrip as 'desc_condclim',
	surc.surc_sumario.SURC_Sumario_IdVehicHecho as 'Id_vehichecho',
	surc.surc_vehiculohecho.SURC_VehiculoHecho_Descrip as 'desc_vehichecho',
	surc.surc_sumario.SURC_Sumario_horaimpr FROM	surc.surc_sumario
	...
	where SURC_Sumario_Id='$_REQUEST[SURC_Sumario_Id]'") or die("Problemas con la consulta sumarios : ".mysqli_error($conex_surc));
...
//
//  where SURC_Sumario_Id='$_SESSION[SURC_Sumario_Id]'
//  order by surc.surc_sumarioelemento.SURC_SumarioElemento_Id") or die("Problemas con la consulta elemento sumarios : ".mysqli_error($conex_surc));
//
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/abm.css?v=2.033">
		...
		<script type="text/javascript" src="sum_d_gral_ins.js?v=2.2"></script>
  ...
  <section>
		<div class="mensaje">
					<div id="mensaje"> <?php
						if (isset ($_REQUEST['accion'])) {
							if ($_REQUEST['accion'] == 'mod') {
								echo '<span class="naranja">El registro fue modificado con éxito</span>';
							} elseif ($_REQUEST['accion'] == 'ins') {
								echo '<span class="naranja">El registro fue agregado con éxito</span>';
							} elseif ($_REQUEST['accion'] == 'errordlio') {
								echo '<span class="naranja">El registro tuvo en error en el ingreso domicilio</span>';
							} elseif ($_REQUEST['accion'] == 'existepase') {
								echo '<span class="rojo">No se realizó la operación requerida. Por favor verifique</span>';
							} elseif ($_REQUEST['accion'] == 'error') {
								echo '<span class="rojo">Los datos ingresados no son válidos</span>';
							} elseif ($_REQUEST['accion'] == 'no_ins') {
								echo '<span class="naranja">No se pudo insertar el registro. Intente nuevamente</span>';
							} elseif ($_REQUEST['accion'] == 'no_ins_dupl') {
								echo '<span class="rojo">No se pudo insertar el sumario porque ya existe otro con el mismo año, nro. sumario, dependencia y tipo sumario. Verificar</span>';
							} elseif ($_REQUEST['accion'] == 'env') {
								echo '<span class="naranja">La actuación fue enviada con éxito</span>';
							}
						} ?>
					</div>
		</div>
    ...
    <article id="artwo">
        <div class="titulo">
            ...
            <div class="postitulo">Alta Sumario del Ministerio Público Fiscal</div>
        </div>
        ...
        <ul class="tabs group">
          <li <?php if ($activo==0) echo 'class="active"' ?>> <a href="sum_d_upd.php?tab=0">General</a></li>
          <!-- <li <?php if ($activo==1) echo 'class="active"' ?> ><a href="sum_d_upd.php?tab=1">Hecho</a> </li>
          <li <?php if ($activo==2) echo 'class="active"' ?>> <a href="sum_d_upd.php?tab=2">Personas</a> </li>
          <li <?php if ($activo==3) echo 'class="active"' ?>> <a href="sum_d_upd.php?tab=3">Elementos</a> </li> -->
    		...
    		<div id="content">
					<?php
						if ($activo==0) {
							include 'sum_d_gral_ins.php';
						}
						// elseif ($activo == 1) {
						// 		 include 'sum_d_hecho_upd.php';
						// } elseif ($activo==2) {
						// 		 include 'sum_d_pers_upd.php';
						// } elseif ($activo==3) {
						// 	include 'sum_d_elem_upd.php';
						// }
					?>
