...
<html lang="en" dir="ltr">
  ...
  <body>
    <div id="map">
      <script>
          let map= L.map('map').setView([<?php echo $row_sumarios['Coord_X']; ?>, <?php echo $row_sumarios['Coord_Y']; ?>], 15);
          ...
          var marker = L.marker([<?php echo $row_sumarios['Coord_X']; ?>, <?php echo $row_sumarios['Coord_Y']; ?>],{
            draggable: 'true'
          }).addTo(map);
