...
*/
    ...
    $sumario_excel=mysqli_query($conex_surc,"SELECT  `surc`.`surc_sumario`.`SURC_Sumario_NroSumMP` AS `NroSumario_MP`,
      ...
      Tipo_Persona, Clase_Persona, Vinculo_Persona, Documento, ApellidoyNombre, Sexo, Fecha_Nac,Edad,Alias,Telefono,Est_Civil
  FROM
      ((((((((((((((((`surc`.`surc_sumario`
      ...
      INNER JOIN surc.personasumario on surc.personasumario.SURC_Sumario_Id=surc.surc_sumario.SURC_Sumario_Id
