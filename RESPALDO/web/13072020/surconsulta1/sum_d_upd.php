...
$sumarios= mysqli_query($conex_surc,"SELECT SURC_Sumario_Id, SURC_Sumario_NroDenunciaMP as 'xml', SURC_Sumario_NroSumMP AS 'NroSumario_MP',
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/abm.css?v=2.033">
		...
		<script type="text/javascript" src="sum_d_gral_upd.js?v=1.05"></script>
</head>
<body>
  <header>
		<div id="main">
