...
<body>
  ...
  <section>
    <article id="artwo">
        ...
        <ul class="tabs group">
          <li <?php if ($activo==0) echo 'class="active"' ?>> <a href="sum_d_personas.php?tab=0">General</a></li>
          <li <?php if ($activo==1) echo 'class="active"' ?> ><a href="sum_d_personas.php?tab=1">Hecho</a> </li>
          <li <?php if ($activo==2) echo 'class="active"' ?>> <a href="sum_d_personas.php?tab=2">Personas</a> </li>
          <li <?php if ($activo==3) echo 'class="active"' ?>> <a href="sum_d_personas.php?tab=3">Elementos</a> </li>
