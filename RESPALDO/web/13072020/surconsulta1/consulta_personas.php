      ...
      <section id="buscador_elemen">
        ...
        <div id="find">
          <div id="cpanel1">
            ...
            <form action="consulta_personas.php" method="get" id="limpiar"></form>
                ...
                <?php
                  ...
                  if (!empty($num_row_personas)) {
                      ...
                      ++$impresos;?>
                        <tr>
                          <td><?= $impresos ?></td>
                          <td><?= utf8_encode($row_personas['NroSumario_MP']) ?></td>
                          <td><?= utf8_encode($row_personas['Anio']) ?></td>
                          <td><?= utf8_encode($row_personas['Dependencia']) ?></td>
                          <td><?= date("d-m-Y",strtotime($row_personas['Fecha_delito'])) ?></td>
                          ...
                          <td><?= date("d-m-Y",strtotime($row_personas['Fecha_Nac'])) ?></td>
