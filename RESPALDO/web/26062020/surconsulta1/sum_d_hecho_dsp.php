  ...
  <body>
    ...
    <table class="plus conmargen">
      ...
      <tr>
        <td>Tentativa</td>
        <td>
          <input type="checkbox" name="" value="<?= utf8_encode($row_sumarios['tentativa'])?>" readonly>
        </td>
      </tr>
      <tr>
        <td>Violencia Familiar (VIF)</td>
        <td>
          <input type="checkbox" name="" value="<?= utf8_encode($row_sumarios['hechodelictivo_vif'])?>" readonly>
        </td>
      </tr>
      <tr>
