...
<html lang="en" dir="ltr">
  ...
  <body>
    <form class="" action="sum_d_gral_upd.php" method="get">
      <table ALIGN="right">
        <tr>
          <td>
    ...
    <table class="plus conmargen">
      ...
      <tr>
        ...
        <td>
          <input type="text" list="barrio" id="barrios" name="Barrio_Codigo" class="w18" value="<?php if (!empty($row_sumarios['Id_Barrio'])) {
