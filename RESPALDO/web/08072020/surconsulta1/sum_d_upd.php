		...
		<div class="mensaje">
					<div id="mensaje"> <?php
						if (isset ($_REQUEST['accion'])) {
							...
							} elseif ($_REQUEST['accion'] == 'anulado') {
								echo '<span class="naranja">La actuación fue anulada con éxito</span>';
							...
							} elseif ($_REQUEST['accion'] == 'auto') {
								echo '<span class="naranja">El autopase fue realizado con éxito</span>';
							} elseif ($_REQUEST['accion'] == 'no_upd') {
								echo '<span class="rojo">No se pudo realizar la modificacion del registro. Por favor, intente nuevamente</span>';
