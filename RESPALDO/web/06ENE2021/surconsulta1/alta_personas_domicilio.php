          ...
          <table ALIGN="right">
                ...
                <table class="plus conmargen">
                    ...
                    <tr>
                      <td>Pais</td>
                      <td>
                        <select type="text" class="select" id="idpais" name="SURC_DomiciliosPers_IdPais">
                      ...
                      <td>Provincia</td>
                      <td>
                        <select type="text" class="select" id="id_provincia" name="SURC_DomiciliosPers_IdProvinci">
                            <option value="">Seleccionar</option>
                            <?php
