...
if (!empty($_REQUEST['SURC_Sumario_ViolGenero']) and ($_REQUEST['SURC_Sumario_ViolGenero']=='vg')) {
...
$row_usuario=mysqli_fetch_array($usuario);
  ...
  $sumario_auditoria=mysqli_query($conex_surc,"SELECT * FROM surc.surc_sumario WHERE
   ...
   mysqli_query($conex_surc, "UPDATE surc.surc_sumario SET
    ...
    SURC_Sumario_ViolGenero='$SURC_Sumario_ViolGenero',
    ...
    // insertar registro
     ...
     while ($row_sumario_auditoria = mysqli_fetch_array($sumario_auditoria)) {
       if ($row_sumario_auditoria['SURC_Sumario_IdHechoDel']!=$SURC_Sumario_IdHechoDel) {
        ...
        if ($row_sumario_auditoria['SURC_Sumario_ViolGenero']!=$SURC_Sumario_ViolGenero) {
            $activ=$activ.' '."SURC_Sumario_ViolGenero".':'.$row_sumario_auditoria['SURC_Sumario_ViolGenero'].' '.$SURC_Sumario_ViolGenero;
        }
