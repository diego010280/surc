...
SURC_Sumario_Anio AS 'Anio', SURC_TipoDelito_Descripc as 'Caratula',dbseg.ref_dependencias.DepPol_Descrip AS 'Dependencia', surc.surc_tiposum.SURC_TipoSum_Descrip AS 'Tipo_Sumario',		
surc.surc_origensumario.SURC_OrigenSumario_Descrip AS 'Origen_Sumario',	dbseg.ref_localidad.Localidad_Descrip AS Localidad,	dbseg.ref_barrio.Barrio_Descrip AS 'Barrio',
SURC_Sumario_NomCalle AS 'Nom_Calle', SURC_Sumario_AltCalle AS 'Alt_Calle', SURC_Sumario_Piso as 'Piso', SURC_Sumario_Dpto as 'Dpto', SURC_Sumario_Mza as 'Mza', SURC_Sumario_CasaLote as 'lote', 
SURC_Sumario_CoordX AS 'Coord_X', SURC_Sumario_CoordY AS 'Coord_Y', surc.surc_cuadriculas.SURC_Cuadriculas_Descrip AS 'Cuadricula',
...
SURC_Sumario_TextoRelato AS 'Descrip_Hecho', SURC_Sumario_IdHechoDel as 'Id_Hechodelictivo', surc.surc_hechodelictivo.SURC_HechoDelictivo_Descrip as 'Tipo_hechodelictivo',
surc.surc_sumario.SURC_Sumario_Tentativa as 'tentativa', surc.surc_sumario.SURC_HechoDelictivo_VIF as 'hechodelictivo_vif', surc.surc_sumario.SURC_Sumario_IdArmaMec as 'Id_armamec', 
surc.surc_armamecanismo.SURC_ArmaMecanismo_Descrip as 'desc_armamec', surc.surc_sumario.SURC_Sumario_IdFormaAcc as 'Id_formaacc', surc.surc_formaaccion.SURC_FormaAccion_Descrip as 'desc_formaacc', 
surc.surc_sumario.SURC_Sumario_IdModalidad as 'Id_modalidad', surc.surc_modalidad.SURC_Modalidad_Descrip as 'desc_modalidad', surc.surc_sumario.SURC_Sumario_IdModoProd as 'Id_modoprod', 
surc.surc_modoproduccion.SURC_ModoProduccion_Descrip as 'desc_modoprod', surc.surc_sumario.SURC_Sumario_IdCondClim as 'Id_condclim', surc.surc_condclimatica.SURC_CondClimatica_Descrip as 'desc_condclim', 
...
surc.surc_sumario.SURC_Sumario_horaimpr 
...
<body>
  ...
  <section>
    <article id="artwo">
        ...
        <ul class="tabs group">
          <li <?php if ($activo==0) echo 'class="active"' ?>> <a href="sum_d_vif.php?tab=0">General</a></li>
          <li <?php if ($activo==1) echo 'class="active"' ?> ><a href="sum_d_vif.php?tab=1">Hecho</a> </li>
          <li <?php if ($activo==2) echo 'class="active"' ?>> <a href="sum_d_vif.php?tab=2">Personas</a> </li>
          <li <?php if ($activo==3) echo 'class="active"' ?>> <a href="sum_d_vif.php?tab=3">Elementos</a> </li>
