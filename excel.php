...
if (isset($_REQUEST['excel']) and $_REQUEST['excel']=='excel') {
...
<body>
	...
	<th style="background-color:#D8D8D8; height:35px;">Nro</th>
      ...
      <th style="background-color:#D8D8D8;">Hora Imprecisa</th>
  ...
  <?php
    if (!empty($num_row_sumarios)) {
      ...
      //**********auditoria**********************//
       ...
       // insertar registro
        $activ="Descarga_de_Excel_Sumario. "."PalabraClave:".$palabra_clave.
        " Nrosumario:".$nrosumario_mp." Año:".$anio." Tiposumario:".$SURC_TipoSum_Id.
        " Origensum:".$SURC_OrigenSumario_Id." idcco:".$SURC_CCO_Id." idsector:".$SURC_Sectores_Id.
        " Dependencia:".$codigo_dep." desdehecho:".$desdehecho." hastahecho:".$hastahecho.
        " desde carga:".$desdecarga." hastacarga:".$hastacarga." grupodelito:".$SURC_TipoGrDelito_Id.
        " idhechodelictiv:".$SURC_HechoDelictivo_Id." Modalidadid:".$SURC_Modalidad_Id." dduurr:".$UnidadReg_Codigo.
        " numeroxml:".$num_xml;
                  
        mysqli_query($connaud,"SET NAMES 'utf8'");
        mysqli_query($connaud, "INSERT INTO auditoria
          (auditoria_usuario_id, auditoria_moduloId, auditoria_action_id, auditoria_descrip)

        VALUES ('$_SESSION[usuario_id]','$_SESSION[moduleid]','2','$activ')");


      //fin registro actividad auditoria
  }else {

    $activ="Descarga de Excel Sumario vacia."."PalabraClave:".$palabra_clave.
    " Nrosumario:".$nrosumario_mp." Año:".$anio." Tiposumario:".$SURC_TipoSum_Id.
    " Origensum:".$SURC_OrigenSumario_Id." idcco:".$SURC_CCO_Id." idsector:".$SURC_Sectores_Id.
    " Dependencia:".$codigo_dep." desdehecho:".$desdehecho." hastahecho:".$hastahecho.
    " desde carga:".$desdecarga." hastacarga:".$hastacarga." grupodelito:".$SURC_TipoGrDelito_Id.
