...
<body>
  ...
  <section>
    ...
    <article id="artUno">
        <section id='buscador2' style="min-height:auto">
                    ...
                    <div id="cpanel1">
						...
						<form action="consulta_sum_vif.php" method="post" autocomplete="off">
							...
							<div class="pos_buscar">
							 ...
							 <div class="pos_buscar">
								 <button type="submit" class="btncel" form="volvervif"><span class="soloimagen">Volver a VIF</span></button>
							 </div>
...
<!-----------------------------------------------BOTON VOLVER A VIF------------------------------------------------------------------------------->		
						...
						<form action="../vif/segacceso/checks_intermod_volver.php" method="post" id="volvervif">
