...
$barrio = mysqli_query($conex_dbseg,"SELECT * FROM dbseg.ref_barrio WHERE Localidad_Codigo = '$local_id'
order by Barrio_Descrip;") or die ('Problemas con select ref_barrio'.mysqli_error($conex_dbseg));
...
<input type="text" list="idbarrios" name="Barrio_Codigo" placeholder="Seleccionar..." autocomplete="off">
	<?php
