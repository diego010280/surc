...
if (isset($_REQUEST['buscador']) or isset($_REQUEST['go_back'])) {
    ...
    if (empty($_REQUEST['nrosumario_mp']) and empty($_REQUEST['palabra_clave']) and empty($_REQUEST['anio']) and empty($_REQUEST['SURC_TipoSum_Id']) and empty($_REQUEST['SURC_OrigenSumario_Id']) and
        ...
        empty($_REQUEST['desdehecho']) and empty($_REQUEST['hastahecho']) and empty($_REQUEST['SURC_TipoGrDelito_Id']) and empty($_REQUEST['SURC_HechoDelictivo_Id']) and empty($_REQUEST['UnidadReg_Codigo'])) {
        ...
        <section id='buscador'>
              ...
              <div id="find">
                  ...
                  <div id="cpanel1">
                    ...
                    <form action="consulta_denuncia.php" method="post" autocomplete="off">
                                  ...
                                  <select name="SURC_CCO_Id" onchange="submit()" <?php if ($foco1==0) {echo 'autofocus';} else {
                                    echo 'disabled';} ?> >
                                        ...
                                        <?php
                                          ...
                                          where SURC_CCO_Activo=1") or die("Problemas con el select área geográfica : ".mysqli_error($conex_surc));
                   ...
                   <form action="consulta_denuncia.php" method="post" id="limpiar"></form>
                                ...
                                while ($row_sumarios = mysqli_fetch_array($sumarios)) {
                                  ++$impresos;?>
                                    ...
                                    <td><?= $row_sumarios['NroSumario_MP'] ?></td>
                            			...
                            			<td>
                                          <form action="sum_d_denuncia.php" method="post">
                  ...
                  <tr>
                    <td align="right" width="92%" valign="middle">
                  	...
                  	<td align="right">
                					...
                					?>
                						<form action="consulta_denuncia.php" method="post">
