...
<body>
    ...
    <section>
		<article>
			...
			<table width="70%" cellspacing="0" >
								...
								<form  enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" >
									...
									<table width="100%">
										<tr>
											...
											<td>
												<input class="aceptar" type="submit" value="Guardar cambios">
												<input class="cancel" type="button" value="Cancelar" onclick="window.location ='<?= $_SERVER['PHP_SELF'] ?>'">
											</td>
										</tr>
									</table>
								</form>
				...
				<?php
								...
								<form name="email" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" >
									<table width="100%" >
										<tr>
											...
											<td>
												<input class="aceptar" type="submit" value="Guardar cambios">
												<input class="cancel" type="button" value="Cancelar" onclick="window.location ='<?php echo $_SERVER['PHP_SELF']; ?>'">
											</td>
										</tr>
									</table>
								</form>
					...
					<tr class="alternar alto">
						...
						<td>
							<?php if ($row_usuario['usuario_email']==NULL){ echo '<span style="color:#666666">Sin registro.</span>';}  else { echo utf8_encode($row_usuario['usuario_email']);} ?>
						</td>
						<td>
									...
									<table width="100%" >
										<tr>
											...
											<td>
												...
												<input name="psw" type="password" autofocus value="" pattern=".{4,}" title="La contraseña debe contener como minimo 4 caracteres" required>
											</td>
											<td>
												<input class="aceptar" type="submit" value="Guardar cambios">
												<input class="cancel" type="button" value="Cancelar" onclick="window.location ='<?= $_SERVER['PHP_SELF'] ?>'">
			...
			<form action="ctrlpanel.php" method="post">
