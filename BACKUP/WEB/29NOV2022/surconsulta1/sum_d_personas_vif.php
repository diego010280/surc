...
if (!empty($_REQUEST['SURC_Sumario_Id'])) {
	...
	$_SESSION['palabra_clave_pers'] = $_REQUEST['palabra_clave_pers'];
...
<body>
  ...
  <section>
    <article id="artwo">
        <div class="titulo">
            ...
            <div class="postitulo">Sumario del Ministerio Público Fiscal</div>
				...
				<div class="pos_buscar">
					<form action="consulta_personas_vif.php" method="post">

							<input type="hidden" name="go_back" value="<?php echo $_SESSION['go_back']; ?>">
							<input type="hidden" name="palabra_clave_pers" value="<?php echo $_SESSION['palabra_clave_pers']; ?>">
        ...
        <ul class="tabs group">
          <li <?php if ($activo==0) echo 'class="active"' ?>> <a href="sum_d_personas_vif.php?tab=0">General</a></li>
          <li <?php if ($activo==1) echo 'class="active"' ?> ><a href="sum_d_personas_vif.php?tab=1">Hecho</a> </li>
          <li <?php if ($activo==2) echo 'class="active"' ?>> <a href="sum_d_personas_vif.php?tab=2">Personas</a> </li>
          <li <?php if ($activo==3) echo 'class="active"' ?>> <a href="sum_d_personas_vif.php?tab=3">Elementos</a> </li>
          <!-- <li <?php //if ($activo==4) echo 'class="active"' ?>> <a href="sum_d_personas.php?tab=4">Ampliaciones</a> </li> -->
