...
if (isset($_REQUEST['buscador']) or isset($_REQUEST['go_back'])) {
    ...
    if (empty($_REQUEST['nrosumario_mp']) and empty($_REQUEST['palabra_clave']) and empty($_REQUEST['anio']) and empty($_REQUEST['SURC_TipoSum_Id']) and empty($_REQUEST['SURC_OrigenSumario_Id']) and
        ...
        empty($_REQUEST['SURC_TipoGrDelito_Id']) and empty($_REQUEST['SURC_HechoDelictivo_Id']) and empty($_REQUEST['SURC_Modalidad_Id']) and empty($_REQUEST['UnidadReg_Codigo']) AND
        empty($_REQUEST['usuario']) and empty($_REQUEST['num_xml'])) {
	...
	*/
      ...
      AND (surc.surc_sumario.SURC_Sumario_NroDenunciaMP LIKE '$num_xml' or '$num_xml'='')
		  LIMIT $inicio, $tamano_pagina ") or die("Problemas con el select consulta datos script consulta_sum.php : ".mysqli_error($conex_surc));;
        ...
        <section id='buscador'>
              ...
              <div id="find">
                  ...
                  <div id="cpanel1">
                    ...
                    <form action="consulta_sum_2.php" method="post" autocomplete="off">
                        ...
                        <table class="plus conmargen">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>&nbsp; &nbsp; </td>
                              <td>
                                <input type="text" name="num_xml" value="<?php if (isset($_REQUEST['num_xml'])) {
                                  echo $_REQUEST['num_xml'];
                                }else {
                                  echo "";
                                }?>" maxlength="40">
                              </td>
                        ...
                        <table class="plus conmargen">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td>
                              <input type="text" list="usu" name="usuario" value="<?php if (isset($_REQUEST['usuario'])) {
                              ...
                              <?php
                                ...
                                $usuarios=mysqli_query($conexion,"SELECT segusuario.usuarios.usuario_id, upper(segusuario.usuarios.usuario_cuenta) as 'usuario_cuenta',
                                        segusuario.usuarios.usuario_nombre,segusuario.usuarios.usuario_apellido,segusuario.usuarios.usuario_estado FROM segusuario.usuarios
                                    where segusuario.usuarios.usuario_estado=1;")
                                    or  die("Problemas con el select de Usuario : ".mysqli_error($conexion));
                                $row_usuarios=mysqli_fetch_array($usuarios);

                                do {?>
                                  <option value="<?php echo utf8_encode($row_usuarios['usuario_cuenta'])."-".utf8_encode($row_usuarios['usuario_apellido']).
                                  ",".utf8_encode($row_usuarios['usuario_nombre']); ?>"></option>
                                  <?php
                                } while ($row_usuarios=mysqli_fetch_array($usuarios));
                                echo "</datalist>";
                                ?>
                   ...
                   <form action="consulta_sum_2.php" method="post" id="limpiar"></form>
                              ...
                              $impresos=0;
                                ...
                                while ($row_sumarios = mysqli_fetch_array($sumarios)) {
                                  ++$impresos;?>
                                    ...
                                    <td>
                                          <form action="sum_d.php" method="post">
                                              ...
                                              <input type="hidden" name="SURC_TipoSum_Id" value="<?= $SURC_TipoSum_Id ?>">
                                              <input type="hidden" name="SURC_OrigenSumario_Id" value="<?= $SURC_OrigenSumario_Id ?>">
                                              ...
                                              <input type="hidden" name="desdecarga" value="<?= $desdecarga ?>">
                                              <input type="hidden" name="hastacarga" value="<?= $_REQUEST['hastacarga'] ?>">
                                              <input type="hidden" name="SURC_TipoGrDelito_Id" value="<?= $SURC_TipoGrDelito_Id ?>">
                                              ...
                                              <input type="hidden" name="num_xml" value="<?= $_REQUEST['num_xml'] ?>">
                                      ...
                                      <?php if ($modif) {?>
                                            <td>
                                              <form class="" action="sum_d_upd.php" method="post">
                  ...
                  <tr>
                    <td align="right" width="92%" valign="middle">
                  	...
                  	<td align="right">
                					...
                					?>
                						<form action="consulta_sum_2.php" method="post">
