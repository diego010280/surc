                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <?php
                              ...
                              if ($row_xml_mp['xml_auditoria_id']>45411) {
                                $link=substr($row_xml_mp['xml_auditoria_ubicacion'],13);
                                echo $link;
                              }else {
                                echo '/xml/'.$row_xml_mp['xml_auditoria_ubicacion'];
                              }

                             ?>" target="_blank"><img src="imagenes/iconos/lupa.png" type="image" width="16" title="Ver" name="boton" src="imagenes/iconos/xml.png" ></a>
