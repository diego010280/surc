...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <table class="plus conmargen">
      ...
      <tr>
        ...
        <td> <input type="time" name="SURC_Sumario_HoraDel" class="w5" value="<?php if (!empty($row_sumarios['Hora_Delito'])) {
            echo date('H:i:s',strtotime("$row_sumarios[Hora_Delito] - 3 hours"));}?>"> </td>
        <td>

          <select type="text" class="select" name="SURC_Sumario_IdLugar" >
                            <option value="">Ninguno</option>
                                <?php
        ...
        <td> <input type="text" name="SURC_Sumario_AltCalle" style="text-transform:uppercase;" class="wchico" value="<?= $row_sumarios['Alt_Calle'] ?>" > </td>
    ...
    <table class="plus conmargen">
      ...
      <tr>
        <td>
            <input type="text" list="idlocalidad" name="Localidad_Codigo" class="w18" value="<?php if (!empty($row_sumarios['Id_localidad'])) {
        ...
        <td>
          <input type="text" list="barrio" name="Barrio_Codigo" class="w18" value="<?php if (!empty($row_sumarios['Id_Barrio'])) {
              echo $row_sumarios['Id_Barrio'].' '.$row_sumarios['Barrio'];
          ...
          <?php
            echo '<datalist id="barrio">';
            $barrio=mysqli_query($conex_dbseg,"SELECT * FROM dbseg.ref_barrio")
                    or  die("Problemas con el select de barrio: ".mysqli_error($conex_dbseg));
