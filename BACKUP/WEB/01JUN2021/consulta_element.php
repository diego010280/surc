                  ...
                  if (!empty($num_row_elementos)) {
                      ...
                      ++$impresos;?>
                        <tr>
                          ...
                          <td align="right"><?= utf8_encode($row_elementos['Nro_sum_mp']) ?></td>
                          <td align="center"><?= utf8_encode($row_elementos['Anio_sum']) ?></td>
                          <td><?= utf8_encode($row_elementos['desc_dependencia']) ?></td>
                          <td align="center"><?= date("d-m-Y",strtotime($row_elementos['fecha_Delito'])) ?></td>
                          <td align="center"><?= utf8_encode($row_elementos['forma']) ?></td>
                          <td><?= utf8_encode($row_elementos['Tipo_Elemento']) ?></td>
                          <td><?= utf8_encode($row_elementos['Numero_de_Serie']) ?></td>
                          <td align="center"><?= $row_elementos['Cantidad'] ?></td>
