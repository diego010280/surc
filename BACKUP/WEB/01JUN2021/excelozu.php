...
if (isset($_REQUEST['excelozu']) and $_REQUEST['excelozu']=='excelozu') {
...
$hastacarga = (empty($_REQUEST['hastacarga'])) ? null : $_REQUEST['hastacarga'];
    ...
    $sumario_excel=mysqli_query($conex_surc,"SELECT
      surc.surc_sumario.SURC_Sumario_Id,
      surc.surc_sumario.SURC_Sumario_NroSumMP AS 'NroSumario_MP',
      surc.surc_sumario.SURC_Sumario_Anio AS 'Anio',

      case month(surc.surc_sumario.SURC_Sumario_FechaDel)
            WHEN 1 THEN 'Enero'
            WHEN 2 THEN  'Febrero'
            WHEN 3 THEN 'Marzo'
            WHEN 4 THEN 'Abril'
      ...
      surc.surc_sumario.SURC_Sumario_Piso AS 'Piso',
      surc.surc_sumario.SURC_Sumario_Dpto AS 'Dpto',
      surc.surc_sumario.SURC_Sumario_Mza AS 'Mza',
      surc.surc_sumario.SURC_Sumario_CasaLote AS 'CasaLote',
      ...
      CAST(surc.surc_sumario.SURC_Sumario_HoraSum
          AS TIME) AS 'Hora_Carga',
...
<body>
	<table style="border: 1px solid #000">
		<tr>
				...
				<th style="background-color:#D8D8D8;">Mes</th>
			  ...
			  <th style="background-color:#D8D8D8;">Piso</th>
			  <th style="background-color:#D8D8D8;">Dpto</th>
			  <th style="background-color:#D8D8D8;">Mza</th>
			  <th style="background-color:#D8D8D8;">Casa Lote</th>
			  ...
			  <th style="background-color:#D8D8D8;">ÚltEstado</th>
			  <th style="background-color:#D8D8D8;">ObservEstado</th>
			  <th style="background-color:#D8D8D8;">Resultado Estado</th>
			  ...
			  <th style="background-color:#D8D8D8;">Delito involucrado un Menor</th>
			  <th style="background-color:#D8D8D8;">Hecho VIF</th>
			  <th style="background-color:#D8D8D8;">Personal Involucrado</th>
			  <th style="background-color:#D8D8D8;">Violencia Escolar</th>
			  <th style="background-color:#D8D8D8;">Elemento Utilizado</th>
			  <th style="background-color:#D8D8D8;">Elemento Sustraído</th>
			  <th style="background-color:#D8D8D8;">Elemento Secuestrado</th>
     ...
     while ($row_sumarios =  mysqli_fetch_array($sumario_excel)) {
        ...
        <tr height="10px">
          ...
          <td><?= utf8_encode($row_sumarios['Piso']) ?></td>
          <td><?= utf8_encode($row_sumarios['Dpto']) ?></td>
          <td><?= utf8_encode($row_sumarios['Mza']) ?></td>
          <td><?= utf8_encode($row_sumarios['CasaLote']) ?></td>
          ...
          <?php include ('buscar_elemento.php'); ?>
          <td>
              <?php
              if ($utilizado=='S'){
                   echo "S";
