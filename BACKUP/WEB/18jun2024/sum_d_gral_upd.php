...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- <script src="js/hora.js?v=2.0.133"></script> -->
  ...
  <body>
    ...
    <table class="plus conmargen">
      ...
      <tr>
        ...
        <td> <input type="time" id="HoraDel" name="SURC_Sumario_HoraDel" class="w5" value="<?php 
              if (!empty($row_sumarios['Hora_Delito'])) {
                  echo date('H:i',strtotime("$row_sumarios[Hora_Delito] - 3 hours"));}?>"<?php if (!empty($row_sumarios['SURC_Sumario_horaimpr'])) {
                    echo "disabled";
                  }
                  ?>> </td>
        ...
        >
            <select type="text" name="SURC_Sumario_horaimpr" id="select_horaimprecisa">
                ...
                <option value="1" <?php if ($row_sumarios['SURC_Sumario_horaimpr'] == 1) echo 'selected';?>>Mañana</option>
                <option value="2" <?php if ($row_sumarios['SURC_Sumario_horaimpr'] == 2) echo 'selected';?>>Tarde</option>
                <option value="3" <?php if ($row_sumarios['SURC_Sumario_horaimpr'] == 3) echo 'selected';?>>Noche</option>
            </select>
        </td>
      </tr>
      </table>
