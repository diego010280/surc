...
if (isset($_REQUEST['btn_guardar_gral_upd']) and $_REQUEST['btn_guardar_gral_upd']=='Guardar Cambios') {
  ...
  $SURC_Sumario_horaimpr=  intval($_REQUEST['SURC_Sumario_horaimpr']);
  ...
  mysqli_query($conex_surc, "UPDATE surc.surc_sumario SET
    ...
    SURC_Sumario_HoraDel= NULLIF('$SURC_Sumario_HoraDel',''),
    SURC_Sumario_horaimpr=NULLIF('$SURC_Sumario_horaimpr','0'),
    ...
    SURC_Sumario_IdCuadricula= NULLIF('$SURC_Cuadriculas_Id','0'),
      ...
      // insertar registro
       ...
       while ($row_sumario_auditoria = mysqli_fetch_array($sumario_auditoria)) {
         if ($row_sumario_auditoria['SURC_Sumario_NroSumMP']!=$SURC_Sumario_NroSumMP) {
          ...
          if ($row_sumario_auditoria['SURC_Sumario_horaimpr']!=$SURC_Sumario_horaimpr) {
              $activ=$activ.' '."SURC_Sumario_horaimpr".':'.$row_sumario_auditoria['SURC_Sumario_horaimpr'].' '.$SURC_Sumario_horaimpr;
          }
