...
if (isset($_REQUEST['btn_guardarelemento_upd']) and $_REQUEST['btn_guardarelemento_upd']=='Guardar Cambios') {
          ...
          $SURC_SumarioElemento_Estado=(empty($_REQUEST['SURC_SumarioElemento_Estado'])) ? 0:intval($_REQUEST['SURC_SumarioElemento_Estado']);
          ...
          $row_usuario=mysqli_fetch_array($usuario);
            ...
            mysqli_query($conex_surc, "UPDATE surc.surc_sumarioelemento SET
               ...
               SURC_SumarioElemento_Estado=nullif('$SURC_SumarioElemento_Estado',0)
                 ...
                 // insertar registro
                  ...
                  while ($row_sumarioelemento_auditoria = mysqli_fetch_array($surc_sumarioelemento_auditoria)) {
                    if ($row_sumarioelemento_auditoria['SURC_SumarioElemento_IdTipoEle']!=$SURC_SumarioElemento_IdTipoEle) {
                     ...
                     if ($row_sumarioelemento_auditoria['SURC_SumarioElemento_Estado']!=$SURC_SumarioElemento_Estado) {
                      $activ=$activ.' '."SURC_SumarioElemento_Estado".':'.$row_sumarioelemento_auditoria['SURC_SumarioElemento_Estado'].' '.$SURC_SumarioElemento_Estado;
                  }
  ...
  <section>
    <article id="artwo">
      ...
      <?php
          ...
          $elementosum=mysqli_query($conex_surc,"SELECT surc_sumarioelemento.*,surc_formaelemento.SURC_FormaElemento_Descrip FROM surc.surc_sumarioelemento
                          left join surc_formaelemento on surc_formaelemento.SURC_FormaElemento_Id=surc_sumarioelemento.SURC_SumarioElemento_IdForma
        ...
        <div class="borde">
          ...
          <table class="plus conmargen">
            ...
            <tr>
              <td>Nro. de Serie</td>
              <td>
                <input type="text" name="SURC_SumarioElemento_NroSerieE" class="w18" style="text-transform:uppercase;" value="<?php echo $row_elementosum['SURC_SumarioElemento_NroSerieE'] ?>">
              </td>
            </tr>
            <tr>
              <td>Cantidad</td>
            ...
            <tr>
                <td>Estado Elemento</td>
                <td>
                  <select type="text" class="select" name="SURC_SumarioElemento_Estado">
                    <option value="">PENDIENTE</option>
                    <option value="1" <?php if ($row_elementosum['SURC_SumarioElemento_Estado']==1) { echo "selected";} ?>>RECUPERADO</option>
                  </select>
