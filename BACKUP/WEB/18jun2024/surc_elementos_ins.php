...
if (isset($_REQUEST['btn_guardarelemento_ins']) and $_REQUEST['btn_guardarelemento_ins']=='Insertar') {
        ...
        $insert_elemento="INSERT INTO surc.surc_sumarioelemento (
                ...
                SURC_SumarioElemento_Obs,SURC_SumarioElemento_IdForma,SURC_SumarioElemento_Estado)
              VALUES (
                ...
                NULLIF('$SURC_SumarioElemento_Obs',''),NULLIF('$SURC_SumarioElemento_IdForma',''),nullif('$SURC_SumarioElemento_Estado',0))";
        ...
        if (mysqli_query($conex_surc,$insert_elemento)) {
          ...
          // insertar registro
           $activ="Alta existosa. surc_sumarioelemento";
