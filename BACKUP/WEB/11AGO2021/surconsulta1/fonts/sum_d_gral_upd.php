...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <table class="plus conmargen">
      ...
      <tr>
        <td>
          <input type="text" list="idlocalidad" id="id_localidad" name="Localidad_Codigo" class="w18" value="<?php if (!empty($row_sumarios['Id_localidad'])) {
        ...
        <td>
              <select type="text" name="Barrio_Codigo" class="select" id="barrios_id">
                <option value="">Seleccione...</option>
                  <?php
                          ...
                          do {?>
                              <option value="<?php echo $row_barrio['Barrio_Codigo'];?>"
                                      <?php if ( isset($row_sumarios['Id_Barrio']) and $row_sumarios['Id_Barrio']==$row_barrio['Barrio_Codigo'] ) {
                                      echo 'selected';
                                        } ?>>
