...
*/
    ...
    $sumario_excel=mysqli_query($conex_surc,"SELECT  `surc`.`surc_sumario`.`SURC_Sumario_NroSumMP` AS `NroSumario_MP`,
      ...
      surc.personasumario.Telefono,surc.personasumario.Est_Civil,surc.surc_sumario.SURC_Sumario_horaimpr
  FROM
      ((((((((((((((((`surc`.`surc_sumario`
  ...
  <?php
    if (!empty($num_row_sumarios)) {
      ...
      //**********auditoria**********************//
       ...
       // insertar registro
        $activ="Descarga_de_Excel_Persona. "."PalabraClave:".$palabra_clave.
    ...
    $activ="Descarga_de_Excel_Personavacia."."PalabraClave:".$palabra_clave.
    " Nrosumario:".$nrosumario_mp." Año:".$anio." Tiposumario:".$SURC_TipoSum_Id.
    " Origensum:".$SURC_OrigenSumario_Id." idcco:".$SURC_CCO_Id." idsector:".$SURC_Sectores_Id.
    " Dependencia:".$codigo_dep." desdehecho:".$desdehecho." hastahecho:".$hastahecho.
    " desde carga:".$desdecarga." hastacarga:".$hastacarga." grupodelito:".$SURC_TipoGrDelito_Id.
